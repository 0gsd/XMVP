...
def carbonate_prompt(title, artist=None, extra_context=None):
    ...
    system_instruction = (
        ...
        "YOUR TASK:\n"
        "1. ANALYZE the Title: Determine its inherent genre and vibe (e.g. Country, Techno, Indie, Jazz, Metal). "
        "DO NOT force a Cyberpunk aesthetic unless the title explicitly suggests it.\n"
        "2. EXTRAPOLATE a Purpose: What is the 'Lesson' or 'thesis' of this video relative to its implied genre?\n"
        "3. GENERATE a 'Situation' Prompt: Write a single, highly detailed paragraph describing the music video's core concept. "
        "Match the visual language to the analyzed genre (e.g. Gritty 16mm for Grunge, Neon for Synthwave, Sepia for Folk).\n\n"
        "OUTPUT FORMAT:\n"
